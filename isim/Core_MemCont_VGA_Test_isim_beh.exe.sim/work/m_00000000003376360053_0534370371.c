...
LAB74:    memcpy(t73, t46, 8);

LAB75:    memset(t104, 0, 8);
    t105 = (t73 + 4);
...
LAB63:    memcpy(t8, t35, 8);

LAB64:    t42 = (t0 + 7096);
    xsi_vlogvar_wait_assign_value(t42, t8, 0, 0, 1, 0LL);
    goto LAB47;
...
LAB60:    xsi_vlog_unsigned_bit_combine(t8, 1, t34, 1, t35, 1);
    goto LAB64;
...
LAB73:    t31 = (t0 + 6456);
    ...
    *((unsigned int *)t34) = t49;
    t50 = *((unsigned int *)t47);
    *((unsigned int *)t47) = (t50 & 15U);
    t51 = *((unsigned int *)t34);
    *((unsigned int *)t34) = (t51 & 15U);
    t42 = ((char*)((ng8)));
    memset(t48, 0, 8);
    t44 = (t47 + 4);
    t45 = (t42 + 4);
...
LAB81:    if (*((unsigned int *)t66) != 0)
        goto LAB82;

LAB83:    t74 = *((unsigned int *)t46);
...
LAB99:    if (*((unsigned int *)t146) != 0)
        goto LAB100;

LAB101:    t154 = *((unsigned int *)t104);
...
LAB102:    t165 = *((unsigned int *)t153);
    t166 = *((unsigned int *)t159);
    *((unsigned int *)t153) = (t165 | t166);
    t167 = (t104 + 4);
    t168 = (t145 + 4);
    t169 = *((unsigned int *)t104);
    t170 = (~(t169));
    t171 = *((unsigned int *)t167);
    t172 = (~(t171));
...
{
	static char *pe[] = {(void *)Initial_25_0,(void *)Initial_26_1,(void *)Initial_27_2,(void *)Always_43_3,(void *)Always_52_4,(void *)Always_64_5,(void *)Always_123_6,(void *)Cont_177_7,(void *)Cont_178_8,(void *)Cont_179_9,(void *)Always_181_10,(void *)Cont_221_11};
	xsi_register_didat("work_m_00000000003376360053_0534370371", "isim/Core_MemCont_VGA_Test_isim_beh.exe.sim/work/m_00000000003376360053_0534370371.didat");
